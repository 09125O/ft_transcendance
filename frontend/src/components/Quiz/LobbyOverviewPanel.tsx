          ...
          <div className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              {QUIZ_CATEGORIES.map((category) => (
                <button
                  className="flex h-full cursor-pointer flex-col gap-3 rounded-[22px] border border-primary/20 bg-background/78 p-4 text-left shadow-[0_24px_56px_-40px_color-mix(in_srgb,var(--color-background)_90%,transparent)] transition duration-200 hover:-translate-y-0.5 hover:border-primary/35"
                  key={category.id}
                  onClick={onGoToReadyQuizzes}
                  type="button"
                >
              ...
              <div className="md:col-span-2 flex justify-center">
                <button
                  className="flex h-full w-full cursor-pointer flex-col gap-3 rounded-[22px] border border-urgency/25 bg-gradient-to-br from-urgency/10 to-background/75 p-4 text-left shadow-[0_24px_56px_-40px_color-mix(in_srgb,var(--color-background)_90%,transparent)] transition duration-200 hover:-translate-y-0.5 hover:border-urgency/45 md:max-w-[28rem]"
                  onClick={onGoToReadyQuizzes}
                  type="button"
                >
                  <span className="w-fit rounded-full border border-urgency/30 bg-urgency/15 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-urgency">
                    Communauté
                  </span>
                  <p className="m-0 text-base font-semibold text-text sm:text-lg">
