  ...
  return (
    <main className="flex flex-1 px-4 py-6 sm:px-6 lg:px-[8%]">
      <div className="flex w-full flex-col gap-6">
        <Panel className="relative overflow-hidden px-6 py-6 before:pointer-events-none before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top_left,color-mix(in_srgb,var(--color-success)_22%,transparent),transparent_58%),radial-gradient(circle_at_top_right,color-mix(in_srgb,var(--color-accent)_18%,transparent),transparent_42%)] before:content-[''] sm:px-8 sm:py-8 lg:px-10">
          <div className="relative space-y-4">
            <span className="font-kicker uppercase tracking-[0.24em] inline-flex w-fit rounded-full border border-success/25 bg-success/10 px-3 py-1 text-xs font-semibold text-success">
              Santé système
            </span>
        ...
        <div className="grid gap-6 xl:grid-cols-3">
          <Panel className="px-6 py-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="font-kicker uppercase tracking-[0.24em] m-0 text-xs text-text/55">Frontend</p>
            ...
            <div className="mt-5 rounded-[20px] border border-text/10 bg-background/70 px-4 py-4 text-sm text-text/70">
          ...
          <Panel className="px-6 py-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="font-kicker uppercase tracking-[0.24em] m-0 text-xs text-text/55">Backend</p>
            ...
            {viewState.status === "error" ? (
              <div className="mt-5 rounded-[20px] border border-urgency/25 bg-urgency/10 px-4 py-4 text-sm text-urgency">
                {viewState.message}
              </div>
            ) : null}
            {health ? (
          ...
          <Panel className="px-6 py-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="font-kicker uppercase tracking-[0.24em] m-0 text-xs text-text/55">Database</p>
            ...
            <div className="mt-5 rounded-[20px] border border-text/10 bg-background/70 px-4 py-4 text-sm text-text/70">
              ...
              {health?.database.error ? (
                <p className="m-0 mt-2 text-urgency">Erreur : {health.database.error}</p>
              ) : null}
            </div>
          </Panel>
        </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
          <div className="flex flex-col gap-6">
            <Panel className="px-6 py-6 sm:px-8">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="font-kicker uppercase tracking-[0.24em] m-0 text-xs text-text/55">Backup</p>
              ...
              <div className="mt-5 rounded-[20px] border border-text/10 bg-background/70 px-4 py-4 text-sm text-text/70">
                ...
                {backup?.error ? (
                  <p className="m-0 mt-2 text-urgency">Erreur : {backup.error}</p>
                ) : null}
                {backup?.message ? (
            ...
            <Panel className="px-6 py-6 sm:px-8">
              <div>
                <p className="font-kicker uppercase tracking-[0.24em] m-0 text-xs text-text/55">Runbook</p>
          ...
          <Panel className="px-6 py-6 sm:px-8">
            <div>
              <p className="font-kicker uppercase tracking-[0.24em] m-0 text-xs text-text/55">Interprétation</p>
